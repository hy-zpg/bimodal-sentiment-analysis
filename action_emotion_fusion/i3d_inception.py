...
base_model = '../keras-kinetics-i3d-action-recognition/trained_model/'
# path to pretrained models with top (classification layer)
WEIGHTS_PATH = {
    'rgb_kinetics_only' : base_model + 'rgb_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels.h5',
    'flow_kinetics_only' : base_model +'flow_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels.h5',
    'rgb_imagenet_and_kinetics' : base_model +'rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels.h5',
    'flow_imagenet_and_kinetics' : base_model +'flow_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels.h5',
}

# path to pretrained models with no top (no classification layer)
WEIGHTS_PATH_NO_TOP = {
    'rgb_kinetics_only' : base_model +'rgb_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels_no_top.h5',
    'flow_kinetics_only' : base_model +'flow_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels_no_top.h5',
    'rgb_imagenet_and_kinetics' : base_model +'rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5',
    'flow_imagenet_and_kinetics' : base_model +'flow_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5',
}
...
def Inception_Inflated3d(include_top=True,
    ...
    if weights in WEIGHTS_NAME:
        if weights == WEIGHTS_NAME[0]:   # rgb_kinetics_only
            if include_top:
                weights_path = WEIGHTS_PATH['rgb_kinetics_only']
            else:
                weights_path = WEIGHTS_PATH_NO_TOP['rgb_kinetics_only']
               
        elif weights == WEIGHTS_NAME[1]: # flow_kinetics_only
            if include_top:
                weights_path = WEIGHTS_PATH['flow_kinetics_only']
            else:
                weights_path = WEIGHTS_PATH_NO_TOP['flow_kinetics_only']               
        elif weights == WEIGHTS_NAME[2]: # rgb_imagenet_and_kinetics
            if include_top:
                weights_path = WEIGHTS_PATH['rgb_imagenet_and_kinetics']
            else:
                weights_path = WEIGHTS_PATH_NO_TOP['rgb_imagenet_and_kinetics']
        elif weights == WEIGHTS_NAME[3]: # flow_imagenet_and_kinetics
            if include_top:
                weights_path = WEIGHTS_PATH['flow_imagenet_and_kinetics']
            else:
                weights_path = WEIGHTS_PATH_NO_TOP['flow_imagenet_and_kinetics']
