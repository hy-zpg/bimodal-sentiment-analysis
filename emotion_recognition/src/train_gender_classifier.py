...
log_file_path = '../trained_models/gender_models/new_trained_model/gender_training.log'
trained_models_path = '../trained_models/gender_models/new_trained_model/gender_mini_XCEPTION'
